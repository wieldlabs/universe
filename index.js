...
const Sentry = require("@sentry/node"), dotenv = require("dotenv"), express = require("express"), resolvers = require("./graphql/resolvers")["resolvers"], loadSchemaSync = require("@graphql-tools/load")["loadSchemaSync"], GraphQLFileLoader = require("@graphql-tools/graphql-file-loader")["GraphQLFileLoader"], connectDB = require("./connectdb")["connectDB"], imageRouter = require("./express-routes/image")["router"], authRouter = require("./express-routes/auth")["router"], referralRouter = require("./express-routes/referral")["router"], utilsRouter = require("./express-routes/utils")["router"], communityRouter = require("./express-routes/community")["router"], metadataRouter = require("./express-routes/metadata")["router"], farcasterRouter = require("./express-routes/farcaster")["router"], farcasterRpgRouter = require("./express-routes/farcaster/rpg")["router"], farcasterTcgRouter = require("./express-routes/farcaster/tcg")["router"], walletRouter = require("./express-routes/wallet")["router"], webhookRouter = require("./express-routes/webhook")["router"], wtfRouter = require("./express-routes/wtf")["router"], publicProfileRouter = require("./express-routes/ens-or-address")["router"], apiKeyRouter = require("./express-routes/apikey")["router"], accountRouter = require("./express-routes/account")["router"], frameRouter = require("./express-routes/frame")["router"], contractsRouter = require("./express-routes/contracts")["router"], opengraphRouter = require("./express-routes/opengraph")["router"], requireAuth = require("./helpers/auth-middleware")["requireAuth"], responseCachePlugin = require("@apollo/server-plugin-response-cache").default, ApolloServer = require("@apollo/server")["ApolloServer"], expressMiddleware = require("@apollo/server/express4")["expressMiddleware"], ApolloServerPluginDrainHttpServer = require("@apollo/server/plugin/drainHttpServer")["ApolloServerPluginDrainHttpServer"], http = require("http"), cors = require("cors"), json = require("body-parser")["json"], _RegistrarService = require("./services/RegistrarService")["Service"], port = parseInt(process.env.PORT, 10) || 8080, typeDefs = loadSchemaSync([ "./graphql/typeDefs/*.gql", "./graphql/typeDefs/**/*.gql" ], {
...
(async () => {
  ...
  app.use("/farcaster/rpg", farcasterRpgRouter), app.use("/farcaster/tcg", farcasterTcgRouter), 
  app.use("/wallet", walletRouter), app.use("/apikey", apiKeyRouter), app.use("/auth", authRouter), 
  app.use("/account", accountRouter), app.use("/frame", frameRouter), app.use("/wtf", wtfRouter), 
