...
(async () => {
  ...
  app.use("/opengraph", opengraphRouter), app.use("/tokens", tokenRouter), app.use("/agents", agentsRouter), 
  app.use("/frame-webhook", frameWebhookRouter), app.use("/farcraft", farcraftRouter), 
