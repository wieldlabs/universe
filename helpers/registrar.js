const BebRegistryBetaController = require("./abi/beb-controller-abi.json"), BebRegistrar = require("./abi/beb-registrar-abi.json"), BebFactoryContract = require("./abi/beb-account-factory-0.json"), OPBebRegistryBetaController = require("./abi/op-controller-abi.json"), BaseBebRegistryBetaController = require("./abi/base-controller-abi.json"), dev = () => ({
