const fidTokenABI = [ {
  ...
  inputs: [],
  name: "InvalidMinSupplyToPerformAction",
  type: "error"
}, {
  inputs: [],
  ...
  inputs: [ {
    ...
    indexed: !1,
    internalType: "enum IFIDToken.MarketType",
    name: "marketType",
    type: "uint8"
  } ],
  name: "FIDTokenBuy",
  ...
  outputs: [ {
    ...
    internalType: "struct IFIDToken.MarketState",
    name: "",
    type: "tuple"
  } ],
  stateMutability: "view",
