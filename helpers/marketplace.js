const MarketplaceV1 = require("./abi/marketplace-v1.json"), MarketplaceV4 = require("./abi/marketplace-v4.json"), MarketplaceV1Proxy = require("./abi/marketplace-v1-proxy.json"), idRegistrarAbi = require("../helpers/abi/id-registrar")["abi"], NFTMarketplace = require("../helpers/abi/nft-marketplace-v1.json"), dev = () => ({
